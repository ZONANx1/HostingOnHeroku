                ...
                <div class="col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-body card-block shadow">
                            <form action="{{ url('admin/edited-user/' . $user->id) }}" method="POST"
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col col-md-3">
                                        <input type="text" name="tinggi" id="tinggi" value="{{ $user->tinggi }}"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col col-md-3">
                                        <input type="text" name="berat" id="berat" value="{{ $user->berat }}"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-5 col-md-9">
                                        <img src="{{ $user->picture }}" class="shadow" style="height: 100px;"
                                            alt="User Image">
                                    </div>
                                </div>
                                <div class="row form-group">
