            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body card-block shadow">
                        <form action="{{url('admin/edited-pembelajaran/'.$pembelajaran->id)}}" method="POST" enctype="multipart/form-data">
                           ...
                           @if ( Session::get('error'))
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3">
                                    <label for="sesi_pembelajaran" class=" form-control-label" required>Sesi Pembelajaran</label>
                                </div>
                                <div class="col-5 col-md-4">
                                    <select name="sesi_pembelajaran" id="sesi_pembelajaran" class="form-control"  required>
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3">
                                 ...
                                 <div class="col col-md-3">               
                                    <input type="time" name="waktu_mula" id="waktu_mula" value="{{$pembelajaran->waktu_mula}}" class="form-control" required>
                                 </div> 
                              </div>
                              <div class="row form-group">
                                <div class="col col-md-3">
                                 ...
                                 <div class="col col-md-3">               
                                    <input type="time" name="waktu_tamat" id="waktu_tamat" value="{{$pembelajaran->waktu_tamat}}" class="form-control" required>
                                 </div> 
                              </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <textarea name="komen" id="komen" rows="2" placeholder="Nyatakan jika ada" 
                            ...
                            <div class="row form-group">
                               ...
                               <div class="col-5 col-md-9">
                                <input type="range" name="progress" id="progress" min="0" max="100" value="{{$pembelajaran->progress}}" oninput="outputId.value = progress.value">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="radio" id="ya" name="kehadiran" value="{{$pembelajaran->kehadiran}}" checked required> Ya</input>
                            </div>
                            </div>
