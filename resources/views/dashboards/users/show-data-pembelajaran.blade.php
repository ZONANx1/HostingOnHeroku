...
@section('title, Data Pembelajaran Pengguna')
...
<body class="">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                &nbsp;
                <h3 class="text-center">Data Pembelajaran Pengguna: {{ Auth::user()->name }}</h3>
                <hr>
            </div>
        </div>
        <div class="row">
    ...
    <script>
        ...
        function fetch(start_date, end_date) {
            $.ajax({
                url: "{{ route('pembelajaran/records') }}",
                type: "GEt",
                data: {
