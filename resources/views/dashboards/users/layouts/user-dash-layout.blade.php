  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="{{ route('user.dashboard')}}" class="d-block admin_name">{{ Auth::user()->name }}</a>
        </div>
        <div class="pull-left info">
            <a href="{{ route('user.dashboard')}}" ><i class="fa fa-circle text-success"></i> Online</a>
        </div>
      </div>
          ...
          <!-- Add icons to the links using the .nav-icon class
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{ route('user.data_kesihatan')}}" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Borang</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="{{ route('user.show_data_kesihatan')}}" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Senarai</p>
                    </a>
                  </li>
                  ...
                  <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="{{ route('user.data_pembelajaran')}}" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                          <p>Borang</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="{{  route('user.show_data_pembelajaran')}}" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                          <p>Senarai</p>
                        </a>
                  </li>     
