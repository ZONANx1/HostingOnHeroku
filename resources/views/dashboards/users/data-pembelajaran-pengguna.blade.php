            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-header" style="background-color: rgb(95, 197, 241); font-colour: white;">
                        <strong><b>Data Pembelajaran</b></strong>
                        <small>Borang</small>
                    </div>
                    <div class="card-body card-block shadow">
                        <form  action="{{ route('adminCreatePembelajaran') }}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="row form-group">
                        ...
                        <div class="row form-group">
                           ...
                           <div class="col-5 col-md-9">
                            <input type="range" name="progress" id="progress" min="0" max="100" value="0" oninput="outputId.value = progress.value">
