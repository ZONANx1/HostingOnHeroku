                ...
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-block shadow">
                            <form action="{{ route('adminCreatePembelajaran') }}" method="POST"
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col col-md-3">
                                        <input type="time" name="waktu_mula" id="waktu_mula" class="form-control"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col col-md-3">
                                        <input type="time" name="waktu_tamat" id="waktu_tamat" class="form-control"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-5 col-md-9">
                                        <input type="range" name="progress" id="progress" min="0" max="100"
                                            value="0" oninput="outputId.value = progress.value">
                                ...
                                <div class=" row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="hidden" id="ya" name="kehadiran" value="Ya" checked
                                            required></input>
                                    </div>
                                </div>
