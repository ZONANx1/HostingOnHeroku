            ...
            <div class="col-md-3">
              ...
              <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                  ...
                  <a href="javascript:void(0)" class="btn btn-primary btn-block" id="change_picture_btn"><b>Tukar Gambar</b></a>
              ...
              <div class="card">
                <div class="card-heker p-2">
                  <ul class="nav nav-pills">
                    <li class="nav-item"><a class="nav-link active" href="#personal_info" data-toggle="tab">Maklumat Peribadi</a></li>
                    <li class="nav-item"><a class="nav-link" href="#change_password" data-toggle="tab">Tukar Kata Laluan </a></li>
                    <li class="nav-item"><a class="nav-link" href="#bmi" data-toggle="tab">Kiraan Jisim Badan Indeks (BMI)</a></li>
                  </ul>
                </div><!-- /.card-header -->
                <div class="card-body">
                    ...
                    <div class="active tab-pane" id="personal_info">
                      <form class="form-horizontal" method="POST" action="{{ route('userUpdateInfo') }}" id="UserInfoForm">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputEmail" placeholder="Emel" value="{{ Auth::user()->email }}" name="email">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputAge" placeholder="Umur" value="{{ Auth::user()->age }}" name="age">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="Tinggi" placeholder="Tinggi" value="{{ Auth::user()->tinggi }}" name="tinggi">
                            <span class="text-danger error-text age_error"></span>
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="Berat" placeholder="Berat" value="{{ Auth::user()->berat }}" name="berat">
                            <span class="text-danger error-text age_error"></span>
                          </div>
                        </div>
                    ...
                    <div class="tab-pane" id="change_password">
                        <form class="form-horizontal" action="{{ route('userChangePassword') }}" method="POST" id="changePasswordUserForm">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="password" class="form-control" id="inputName" placeholder="Masukkan kata laluan lama" name="oldpassword">
                              <span class="text-danger error-text oldpassword_error"></span>
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="inputName2" class="col-sm-2 col-form-label">Kata Laluan Baharu</label>
                            <div class="col-sm-10">
                              <input type="password" class="form-control" id="newpassword" placeholder="Masukkan kata laluan baharu" name="newpassword">
                              <span class="text-danger error-text newpassword_error"></span>
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="inputName2" class="col-sm-2 col-form-label">Sahkan Kata Laluan Baharu</label>
                            <div class="col-sm-10">
                              <input type="password" class="form-control" id="cnewpassword" placeholder="Sahkan kata laluan baharu" name="cnewpassword">
                              <span class="text-danger error-text cnewpassword_error"></span>
                            </div>
                          </div>
                          <div class="form-group row">
                            <div class="offset-sm-2 col-sm-10">
                              <button type="submit" class="btn btn-danger">Kemas Kini Kata Laluan</button>
                            </div>
                          </div>
                        </form>
                      </div>
                      ...
                      <div class="tab-pane" id="bmi">
                        <form id="bmi-form" onsubmit="return calcBMI();">
                          ...
                          <div class="bmi-row">
                            <input id="bmi-weight" type="number" min="1" max="635" value="{{ Auth::user()->berat }}" required/>
                          </div>
                         
                          <div class="bmi-label">Height (<span id="bmi-height-unit">CM</span>):</div>
                          <div class="bmi-row">
                            <input id="bmi-height" type="number" min="54" max="272" value="{{ Auth::user()->tinggi }}" required />
                          </div>
                         <hr>
