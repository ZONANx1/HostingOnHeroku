                        ...
                        <form method="POST" class="signin-form" autocomplete="off" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                <input id="email" type="email" class="form-control" name="email"
                                    placeholder="Masukkan emel" value="{{ old('email') }}" required>
                                <span class="text-danger">
                                    @error('email')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-5 col-md-7">
                                    <input type="range" name="age" id="age" min="60" max="100"
                                        value="60" oninput="outputId.value = age.value">
                            ...
                            <div class="form-group">
                                <input id="password-confirm" type="password" class="form-control"
                                    name="password_confirmation" required data-eye placeholder="Sahkan kata laluan">
                                <span class="text-danger">
                            ...
                            <div class="form-group">
                                <button type="submit" class="form-control btn btn-primary submit px-3">Daftar
                                    Akaun</button>
                            </div>
                        </form>
